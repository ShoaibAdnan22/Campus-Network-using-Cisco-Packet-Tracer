...
This project presents a scalable campus-wide network architecture designed and simulated using Cisco Packet Tracer. The network integrates multiple academic blocks, hostel blocks, library facilities, and centralized server infrastructure to ensure efficient connectivity, resource sharing, and secure communication across the campus environment.

The architecture includes hierarchical routing with dedicated Main Router, College Router, and Hostel Router, enabling inter-network communication between different subnets. Each campus block is connected through managed switches and wireless access points to provide both wired and wireless connectivity for end-user devices such as PCs, laptops, and smartphones.
